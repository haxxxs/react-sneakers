  ...
  return (
    <div className="wrapper clear">
      ...
      <div className="content p-40 ">
        ...
        <div className="card">
          <img height={112} width= {133} src="/imgs/sneakers/2.jpg" alt="sneakers"/>
          <h5>Мужские Кроссовки Nike Blazer Mid Suede</h5>
          <div className="d-flex justify-between align-center">
            <div className="d-flex flex-column">
              <span>Цена:</span>
        ...
        <div className="card">
          <img height={112} width= {133} src="/imgs/sneakers/3.jpg" alt="sneakers"/>
          <h5>Мужские Кроссовки Nike Blazer Mid Suede</h5>
          <div className="d-flex justify-between align-center">
            <div className="d-flex flex-column">
              <span>Цена:</span>
        ...
        <div className="card">
          <img height={112} width= {133} src="/imgs/sneakers/4.jpg" alt="sneakers"/>
          <h5>Мужские Кроссовки Nike Blazer Mid Suede</h5>
          <div className="d-flex justify-between align-center">
            <div className="d-flex flex-column">
              <span>Цена:</span>
